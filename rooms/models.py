...
class Room(core_models.TimeStampedModel):
    ...
    # related_name is a name that allows the one object to access its own ForeignKeys
    # default name is _set
    ...
    # intercepts the saving process and capitalizes the name of the city
